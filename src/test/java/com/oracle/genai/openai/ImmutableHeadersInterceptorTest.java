        ...
        public Call call() {
            return new Call() {
                ...
                public @NotNull <T> T tag(@NotNull KClass<T> kClass, @NotNull Function0<? extends T> function0) {
                    // OkHttp's Call supports KClass-based tags, but Request in OkHttp doesn't.
                    // For this test we don't rely on KClass tags, so just return the default.
                ...
                public @Nullable <T> T tag(@NotNull KClass<T> kClass) {
                    // OkHttp's Call supports KClass-based tags, but Request in OkHttp doesn't.
                    // For this test we don't rely on KClass tags.
                    return null;
                }
